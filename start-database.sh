...
DB_CONTAINER_NAME="nextjs-to-aws-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=nextjs-to-aws -d -p 5432:5432 docker.io/postgres
