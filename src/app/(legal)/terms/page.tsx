      ...
      <article className="flex justify-center">
        <section className="w-full max-w-[800px]">
          <div className="align-center gap-4">
            ...
            <h1>
              <strong>
                {siteConfig.name.toUpperCase()} Terms and Conditions
              </strong>
            </h1>
          </div>
          <br />
          <div>Welcome to {siteConfig.name}!</div>
          <br />

          <p>
            These terms and conditions outline the rules and regulations for the
            use of {siteConfig.name}'s Website, located at{" "}
          ...
          <p>
            ...
            agreed to use cookies in agreement with the {siteConfig.name}'s
            Privacy Policy.{" "}
          </p>
          ...
          <p>
            ...
            {siteConfig.name}. All intellectual property rights are reserved.
            You may access this from {siteConfig.name} for your own personal use
          ...
          <ul>
            ...
            <li>
              Reproduce, duplicate or copy material from {siteConfig.name}
            </li>
          ...
          <p>
            ...
            {siteConfig.name} does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of {siteConfig.name},its agents and/or
            ...
            applicable laws,
            {siteConfig.name} shall not be liable for the Comments or for any
          ...
          <br />
          <p>
            {siteConfig.name} reserves the right to monitor all Comments and to
          ...
          <br />
          <p>
            You hereby grant {siteConfig.name} a non-exclusive license to use,
          ...
          <p>
            ...
            {siteConfig.name}; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to {siteConfig.name}. Please include your name,
          ...
          <p>
            No use of {siteConfig.name}'s logo or other artwork will be allowed
